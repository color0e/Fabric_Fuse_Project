...
namespace g{namespace Fabric{struct Sign;}}
...
struct Sign : ::g::Fuse::Controls::Panel
{
    ...
    static uSStrong<uArray*>& __g_static_nametable1() { return Sign_typeof()->Init(), __g_static_nametable1_; }
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return Sign_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return Sign_typeof()->Init(), __selector1_; }
    static ::g::Uno::UX::Selector __selector2_;
    static ::g::Uno::UX::Selector& __selector2() { return Sign_typeof()->Init(), __selector2_; }
