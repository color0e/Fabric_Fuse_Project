...
void JNICALL callUno_HelloUno_UnoInvokechaincode382(JNIEnv *env,jclass clazz,jobject message,jobject fcn)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_message = JniHelper::JavaToUnoString((jstring)message);
    uString* uno_fcn = JniHelper::JavaToUnoString((jstring)fcn);
    JTRY
        ::g::HelloUno::UnoInvokechaincode(uCast<uString*>(uno_message, ::g::Uno::String_typeof()), uCast<uString*>(uno_fcn, ::g::Uno::String_typeof()));
    JCATCH
}
void JNICALL callUno_HelloUno_UnoLogin384(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_message = JniHelper::JavaToUnoString((jstring)message);
    JTRY
        ::g::HelloUno::UnoLogin(uCast<uString*>(uno_message, ::g::Uno::String_typeof()));
    JCATCH
}
void JNICALL callUno_HelloUno_UnoQuerychaincode386(JNIEnv *env,jclass clazz,jobject message,jobject fcn)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_message = JniHelper::JavaToUnoString((jstring)message);
    uString* uno_fcn = JniHelper::JavaToUnoString((jstring)fcn);
    JTRY
        ::g::HelloUno::UnoQuerychaincode(uCast<uString*>(uno_message, ::g::Uno::String_typeof()), uCast<uString*>(uno_fcn, ::g::Uno::String_typeof()));
    JCATCH
}
void JNICALL callUno_HelloUno_UnoRegister388(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_message = JniHelper::JavaToUnoString((jstring)message);
    JTRY
        ::g::HelloUno::UnoRegister(uCast<uString*>(uno_message, ::g::Uno::String_typeof()));
    JCATCH
}
...
// C:\Users\color0e\AppData\Local\Fusetools\Packages\UnoCore\1.9.0\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\ExternBlockHost.uno
// -------------------------------------------------------------------------------------------------------------------------------------------
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_HelloUno_UnoInvokechaincode382", (char* const)"(Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_HelloUno_UnoInvokechaincode382},
    {(char* const)"callUno_HelloUno_UnoLogin384", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_HelloUno_UnoLogin384},
    {(char* const)"callUno_HelloUno_UnoQuerychaincode386", (char* const)"(Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_HelloUno_UnoQuerychaincode386},
    {(char* const)"callUno_HelloUno_UnoRegister388", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_HelloUno_UnoRegister388},
    };
    int funcCount = 127;
...
// C:\Users\color0e\AppData\Local\Fusetools\Packages\UnoCore\1.9.0\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\UnoArrayEntrypoints.uno
// -----------------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\color0e\AppData\Local\Fusetools\Packages\UnoCore\1.9.0\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\JavaUnoObject.uno
// -----------------------------------------------------------------------------------------------------------------------------------------
