// This file was generated based on '../../AppData/Local/Fusetools/Packages/UnoCore/1.9.0/Backends/CPlusPlus/Uno/_mainMobile.cpp'.
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* Fabric_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* Fabric_FuseControlsTextInputControl_Value_Property_typeof();}
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} ::g::Fuse::Scripting::NativeModule_type* HelloUno_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* Cancel_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* Complete_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* Create_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* Login_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* Money_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* QueryC_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* QueryM_typeof();}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} namespace Fabric{::g::Fuse::Controls::Panel_type* Sign_typeof();}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::Fabric_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::Fabric_FuseControlsTextInputControl_Value_Property_typeof,
        (uType*(*)())&::g::HelloUno_typeof,
        ...
        (uType*(*)())&::g::Fabric::Cancel_typeof,
        (uType*(*)())&::g::Fabric::Complete_typeof,
        (uType*(*)())&::g::Fabric::Create_typeof,
        (uType*(*)())&::g::Fabric::Login_typeof,
        (uType*(*)())&::g::Fabric::Money_typeof,
        (uType*(*)())&::g::Fabric::QueryC_typeof,
        (uType*(*)())&::g::Fabric::QueryM_typeof,
        (uType*(*)())&::g::Fabric::Sign_typeof,
        NULL
    };
