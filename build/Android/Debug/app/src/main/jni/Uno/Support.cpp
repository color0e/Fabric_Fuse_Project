// This file was generated based on '../../AppData/Local/Fusetools/Packages/UnoCore/1.9.0/Backends/CPlusPlus/Uno/Support.cpp'.
...
void uLogv(int level, const char* format, va_list args)
{
    ...
    __android_log_vprint(logs[level], "Fabric", format, args);
#else
