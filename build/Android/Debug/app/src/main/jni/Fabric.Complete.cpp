...
// public partial sealed class Complete :4
// {
// static Complete() :15
static void Complete__cctor_4_fn(uType* __type)
{
    Complete::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"Key"*/], ::STRINGS[1/*"temp_eb1"*/]);
    Complete::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[2/*"Value"*/]);
    Complete::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Key"*/]);
}

static void Complete_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Key");
    ::STRINGS[1] = uString::Const("temp_eb1");
    ::STRINGS[2] = uString::Const("Value");
    ::STRINGS[3] = uString::Const("complete_key");
    ::STRINGS[4] = uString::Const("Completecargo");
    ::STRINGS[5] = uString::Const("completeresult");
    ::STRINGS[6] = uString::Const("Complete.ux");
    ::STRINGS[7] = uString::Const("\n"
        ...
        "\t};\n"
        "\t");
    ::STRINGS[8] = uString::Const("Fabric CompleteContract Test");
    ::STRINGS[9] = uString::Const("Key(ex:20180909_1)");
    ::STRINGS[10] = uString::Const("Complete");
    ...
    type->SetFields(115,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Complete, Key_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Complete, temp_Value_inst), 0,
        ::g::Fuse::Controls::TextInput_typeof(), offsetof(Complete, Key), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(Complete, temp_eb1), 0,
        ::g::Uno::UX::NameTable_typeof(), offsetof(Complete, __g_nametable1), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&Complete::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Complete::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Complete::__selector1_, uFieldFlagsStatic);
}

::g::Fuse::Controls::Panel_type* Complete_typeof()
{
    ...
    options.ObjectSize = sizeof(Complete);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("Fabric.Complete", options);
    type->fp_build_ = Complete_build;
    type->fp_ctor_ = (void*)Complete__New4_fn;
    type->fp_cctor_ = Complete__cctor_4_fn;
...
// public Complete() :19
void Complete__ctor_7_fn(Complete* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :23
void Complete__InitializeUX_fn(Complete* __this)
{
    __this->InitializeUX();
}

// public Complete New() :19
void Complete__New4_fn(Complete** __retval)
{
    *__retval = Complete::New4();
}

uSStrong<uArray*> Complete::__g_static_nametable1_;
::g::Uno::UX::Selector Complete::__selector0_;
::g::Uno::UX::Selector Complete::__selector1_;

// public Complete() [instance] :19
void Complete::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void Complete::InitializeUX()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, Complete::__g_static_nametable1_);
    Key = ::g::Fuse::Controls::TextInput::New3();
    Key_Value_inst = ::g::Fabric_FuseControlsTextInputControl_Value_Property::New1(Key, Complete::__selector0_);
    ::g::Fuse::Reactive::Data* temp1 = ::g::Fuse::Reactive::Data::New1(::STRINGS[3/*"complete_key"*/]);
    ::g::Fuse::Reactive::Data* temp2 = ::g::Fuse::Reactive::Data::New1(::STRINGS[4/*"Completecargo"*/]);
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    temp_Value_inst = ::g::Fabric_FuseControlsTextControl_Value_Property::New1(temp, Complete::__selector0_);
    ::g::Fuse::Reactive::Data* temp3 = ::g::Fuse::Reactive::Data::New1(::STRINGS[5/*"completeres...*/]);
    ...
    SourceLineNumber(1);
    SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    temp4->Code(::STRINGS[7/*"\n\tvar fab...*/]);
    temp4->LineNumber(2);
    temp4->FileName(::STRINGS[6/*"Complete.ux"*/]);
    temp4->SourceLineNumber(2);
    temp4->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    temp5->SourceLineNumber(11);
    temp5->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp6->Value(::STRINGS[8/*"Fabric Comp...*/]);
    temp6->Alignment(10);
    temp6->SourceLineNumber(12);
    temp6->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    uPtr(Key)->Name(Complete::__selector1_);
    uPtr(Key)->SourceLineNumber(14);
    uPtr(Key)->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp7->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp1->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp11->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp12->Value(::STRINGS[10/*"Complete"*/]);
    temp12->TextColor(::g::Fuse::Drawing::Colors::White());
    temp12->Alignment(10);
    temp12->SourceLineNumber(20);
    temp12->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    temp13->SourceLineNumber(21);
    temp13->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    temp13->add_Handler(uDelegate::New(::TYPES[4/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb1)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb1);
    temp2->SourceLineNumber(21);
    temp2->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    temp14->SourceLineNumber(23);
    temp14->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
    ...
    temp3->SourceFileName(::STRINGS[6/*"Complete.ux"*/]);
...
// public Complete New() [static] :19
Complete* Complete::New4()
{
    Complete* obj1 = (Complete*)uNew(Complete_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
