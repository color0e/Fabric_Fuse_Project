...
// {
// static QueryM() :15
static void QueryM__cctor_4_fn(uType* __type)
{
    QueryM::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"Userid"*/], ::STRINGS[1/*"temp_eb9"*/]);
    QueryM::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[2/*"Value"*/]);
    QueryM::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Userid"*/]);
}

static void QueryM_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Userid");
    ::STRINGS[1] = uString::Const("temp_eb9");
    ::STRINGS[2] = uString::Const("Value");
    ::STRINGS[3] = uString::Const("querym_uid");
    ::STRINGS[4] = uString::Const("Querymylist");
    ::STRINGS[5] = uString::Const("querymresult");
    ::STRINGS[6] = uString::Const("QueryM.ux");
    ::STRINGS[7] = uString::Const("\n"
        ...
        "\t};\n"
        "\t");
    ::STRINGS[8] = uString::Const("Fabric QueryMylist Test");
    ::STRINGS[9] = uString::Const("User id");
    ...
    type->SetFields(115,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(QueryM, Userid_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(QueryM, temp_Value_inst), 0,
        ::g::Fuse::Controls::TextInput_typeof(), offsetof(QueryM, Userid), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(QueryM, temp_eb9), 0,
        ::g::Uno::UX::NameTable_typeof(), offsetof(QueryM, __g_nametable1), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&QueryM::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&QueryM::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&QueryM::__selector1_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Panel_type* QueryM_typeof()
{
    ...
    options.ObjectSize = sizeof(QueryM);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("Fabric.QueryM", options);
    type->fp_build_ = QueryM_build;
    type->fp_ctor_ = (void*)QueryM__New4_fn;
    type->fp_cctor_ = QueryM__cctor_4_fn;
...
// public QueryM New() :19
void QueryM__New4_fn(QueryM** __retval)
{
    *__retval = QueryM::New4();
}

uSStrong<uArray*> QueryM::__g_static_nametable1_;
::g::Uno::UX::Selector QueryM::__selector0_;
::g::Uno::UX::Selector QueryM::__selector1_;

// public QueryM() [instance] :19
void QueryM::ctor_7()
{
    ctor_6();
    InitializeUX();
...
void QueryM::InitializeUX()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, QueryM::__g_static_nametable1_);
    Userid = ::g::Fuse::Controls::TextInput::New3();
    Userid_Value_inst = ::g::Fabric_FuseControlsTextInputControl_Value_Property::New1(Userid, QueryM::__selector0_);
    ::g::Fuse::Reactive::Data* temp1 = ::g::Fuse::Reactive::Data::New1(::STRINGS[3/*"querym_uid"*/]);
    ::g::Fuse::Reactive::Data* temp2 = ::g::Fuse::Reactive::Data::New1(::STRINGS[4/*"Querymylist"*/]);
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    temp_Value_inst = ::g::Fabric_FuseControlsTextControl_Value_Property::New1(temp, QueryM::__selector0_);
    ::g::Fuse::Reactive::Data* temp3 = ::g::Fuse::Reactive::Data::New1(::STRINGS[5/*"querymresult"*/]);
    ...
    ::g::Fuse::Reactive::DataBinding* temp10 = ::g::Fuse::Reactive::DataBinding::New1(Userid_Value_inst, (uObject*)temp1, 3);
    ...
    temp_eb9 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp2);
    ...
    SourceLineNumber(1);
    SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    temp4->Code(::STRINGS[7/*"\n\tvar fab...*/]);
    temp4->LineNumber(2);
    temp4->FileName(::STRINGS[6/*"QueryM.ux"*/]);
    temp4->SourceLineNumber(2);
    temp4->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    temp5->SourceLineNumber(10);
    temp5->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp5->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp6);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp5->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), Userid);
    ...
    temp6->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    uPtr(Userid)->PlaceholderText(::STRINGS[9/*"User id"*/]);
    ...
    uPtr(Userid)->Name(QueryM::__selector1_);
    uPtr(Userid)->SourceLineNumber(13);
    uPtr(Userid)->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Userid)->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp7);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Userid)->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp10);
    temp7->Layer(1);
    temp7->SourceLineNumber(14);
    temp7->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ...
    temp1->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ...
    temp11->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ...
    temp12->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    temp13->SourceLineNumber(20);
    temp13->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    temp13->add_Handler(uDelegate::New(::TYPES[4/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb9)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb9);
    temp2->SourceLineNumber(20);
    temp2->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    temp14->SourceLineNumber(22);
    temp14->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ...
    temp->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ...
    temp3->SourceFileName(::STRINGS[6/*"QueryM.ux"*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[5/*Uno.Collections.ICollection<object>*/]), temp_eb9);
...
// public QueryM New() [static] :19
QueryM* QueryM::New4()
{
    QueryM* obj1 = (QueryM*)uNew(QueryM_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
